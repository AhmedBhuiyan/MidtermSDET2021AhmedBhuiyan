...
public class Numbers {
	...
	public static void main(String[] args) throws Exception {
		...
		List<String>bubbleSortNumbers= connectToSqlDB.readDataBase("bubble_sort", "bubbleNumbers");
		...
		List<String>heapSortNumbers= connectToSqlDB.readDataBase("heap_sort", "heapNumbers");
		...
		List<String>bucketNumbers= connectToSqlDB.readDataBase("bucket_sort", "bucketNumbers");
		...
		List<String>quickNumbers= connectToSqlDB.readDataBase("quick_sort", "quickNumbers");
		...
		List<String>mergeNumbers= connectToSqlDB.readDataBase("merge_sort", "mergeNumbers");
		...
		List<String>shellNumbers= connectToSqlDB.readDataBase("shell_sort", "shellNumbers");
